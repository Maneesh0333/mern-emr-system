import { useUpdateAppointmentStatus } from "../../hooks/Admin/useAppointments";
import type { Appointment } from "../../hooks/Doctor/useAppointments";
...
export default function DoctorAppointmentRow({ item }: Props) {
